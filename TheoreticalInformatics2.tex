...
\def\subsetbelow#1#2{\underset{\displaystyle\overset{\displaystyle\rotatebox{270}{$\subset$}}{#2}}{#1}}
...
\def\tobelow#1#2{\underset{\displaystyle\overset{\displaystyle\rotatebox{90}{$\to$}}{#2}}{#1}}
